...
auditCyclesRouter.get('/', asyncHandler(async (req, res) => res.json(await auditsService.list(req.user!))));
...
auditCyclesRouter.get('/:id/items', asyncHandler(async (req, res) => res.json(await auditsService.listItems(req.params.id, req.user!))));
auditCyclesRouter.get('/:id/discrepancies', asyncHandler(async (req, res) => res.json(await auditsService.discrepancies(req.params.id, req.user!))));
